...
import {Avatar, Box, Button, Card, Container, Flex, Group, Input, List, Popover, SegmentedControl, Table, ThemeIcon} from "@mantine/core";
        ...
        { tokens.map(item => (
          <Box key={item.id} className={`${item.id == token?.id ? '' : 'hidden'}`}>
            ...
            <Flex direction={{base: 'column', md: 'row'}} gap="md">
              ...
              <Flex className="max-md:w-full max-md:mx-auto" justify="center">
                <Calendar
                  size="xl"
                  locale={'zh-CN'}
                  getDayProps={(date) => {
