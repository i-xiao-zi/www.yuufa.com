...
import { ActionIcon, CloseButton, Container, Input, Popover, PopoverDropdown, PopoverTarget, SegmentedControl, Tabs, TabsList, TabsPanel, TabsTab } from "@mantine/core";
              ...
              <Input
                ...
                leftSection={
                  <Popover position="bottom-end" withArrow shadow="md">
                    <PopoverTarget>
                      <ActionIcon bdrs="0" className="self-stretch flex-auto h-[unset]! active:transform-none!">
